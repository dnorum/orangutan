...
reset
set title "Distribution of ".n_books." Book Thicknesses Selected for Analysis"
set xlabel 'Thickness [in]'
set ylabel 'Number of Books'
set timestamp # turn on a date/time indicator
set datafile separator ","
set term postscript
set output DIR."/plots/book_thicknesses_selection.ps"
...
plot DIR."/working/book_dimensions_selection.csv" every ::1 using (hist($4,width)):(1.0) smooth freq w boxes lc rgb"green" notitle
