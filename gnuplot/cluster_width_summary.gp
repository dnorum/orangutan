...
set term postscript
set output DIR."/working/cluster_".cluster."/plots/book_widths_summary.ps"
...
plot DIR."/working/cluster_".cluster."/book_dimensions_summary.csv" every ::1 using (hist($3,width)):(1.0) smooth freq w boxes lc rgb"green" notitle
