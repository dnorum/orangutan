...
set term postscript
set output DIR."/plots/book_thicknesses_summary.ps"
...
plot DIR."/working/book_dimensions_summary.csv" every ::1 using (hist($4,width)):(1.0) smooth freq w boxes lc rgb"green" notitle
