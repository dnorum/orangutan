...
set term postscript
set output DIR."/working/cluster_".cluster."/plots/book_heights_summary.ps"
...
plot DIR."/working/cluster_".cluster."/book_dimensions_summary.csv" every ::1 using (hist($2,width)):(1.0) smooth freq w boxes lc rgb"green" notitle
