reset
set title "Distribution of ".n_books." Book Heights & Widths in Cluster ".cluster.", Weighted by Thickness"
...
set palette defined
set output DIR."/plots/cluster_".cluster."/book_heights_widths_weighted_summary.ps"
